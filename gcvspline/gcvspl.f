...
c This version contains cf2py variable types lines 266-268 to make the wrapping with f2py possible.
c
c f2py initialisation by typing in command line: f2py -c -m gcvspl gcvspl.f
c***********************************************************************
c
